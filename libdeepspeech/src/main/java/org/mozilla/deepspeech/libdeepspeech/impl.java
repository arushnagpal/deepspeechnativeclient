...
public class impl {
  ...
  public static int CreateModel(String aModelPath, long aNCep, long aNContext, String aAlphabetConfigPath, long aBeamWidth, SWIGTYPE_p_p_ModelState retval) {
    return implJNI.CreateModel(aModelPath, aNCep, aNContext, aAlphabetConfigPath, aBeamWidth, SWIGTYPE_p_p_ModelState.getCPtr(retval));
  }

  public static void DestroyModel(SWIGTYPE_p_ModelState ctx) {
    implJNI.DestroyModel(SWIGTYPE_p_ModelState.getCPtr(ctx));
  }

  public static int EnableDecoderWithLM(SWIGTYPE_p_ModelState aCtx, String aAlphabetConfigPath, String aLMPath, String aTriePath, float aLMAlpha, float aLMBeta) {
    return implJNI.EnableDecoderWithLM(SWIGTYPE_p_ModelState.getCPtr(aCtx), aAlphabetConfigPath, aLMPath, aTriePath, aLMAlpha, aLMBeta);
  }

  public static String SpeechToText(SWIGTYPE_p_ModelState aCtx, short[] aBuffer, long aBufferSize, long aSampleRate) {
    return implJNI.SpeechToText(SWIGTYPE_p_ModelState.getCPtr(aCtx), aBuffer, aBufferSize, aSampleRate);
  }

  public static Metadata SpeechToTextWithMetadata(SWIGTYPE_p_ModelState aCtx, short[] aBuffer, long aBufferSize, long aSampleRate) {
    long cPtr = implJNI.SpeechToTextWithMetadata(SWIGTYPE_p_ModelState.getCPtr(aCtx), aBuffer, aBufferSize, aSampleRate);
    return (cPtr == 0) ? null : new Metadata(cPtr, false);
  }

  public static int SetupStream(SWIGTYPE_p_ModelState aCtx, long aPreAllocFrames, long aSampleRate, SWIGTYPE_p_p_StreamingState retval) {
    return implJNI.SetupStream(SWIGTYPE_p_ModelState.getCPtr(aCtx), aPreAllocFrames, aSampleRate, SWIGTYPE_p_p_StreamingState.getCPtr(retval));
  }
  ...
  public static void DiscardStream(SWIGTYPE_p_StreamingState aSctx) {
    implJNI.DiscardStream(SWIGTYPE_p_StreamingState.getCPtr(aSctx));
  }
